...
import {StyleSheet, Text, View, Image, useWindowDimensions, ScrollView, ActivityIndicator} from 'react-native';
...
export default function SignInScreen() {
    ...
    const onSignInPressed = () => {
        ...
        fetch(apiUrl+`Device/Authenticate?userName=${username}&password=${password}`, {
            method: 'POST',
            headers: {
